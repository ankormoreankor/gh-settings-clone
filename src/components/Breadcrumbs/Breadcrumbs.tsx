...
export const Breadcrumbs: FC<BreadcrumbsProps> = ({
  ...
  return (
    <div className={clsx(scss.breadcrumbsRoot, className)}>
          ...
          <Fragment key={id}>
            ...
            <span className={scss.item}>
              ...
              {!isLastItem && onClick && (
                <button
                  type="button"
                  className={clsx(utility.buttonReset, scss.link)}
              ...
              {!isLastItem && !onClick && (
                <span
                  className={clsx(!isFirstItem && utility.ellipsis)}
              ...
              {isLastItem && (
                <span
                  className={clsx(scss.lastItem, utility.ellipsis)}
