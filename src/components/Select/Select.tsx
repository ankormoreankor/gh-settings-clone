    ...
    >
      ...
      <RadixSelect.Portal {...portalProps}>
        <RadixSelect.Content
          ...
          className={clsx(scss.selectRoot, scss[width], className)}
            ...
            <ScrollArea isWithHorizontalScrollbar={false}>
              {items.map(
                ({
                  ...
                  const tooltipClassNames = clsx(tooltipProps?.className, scss.itemTooltip);
                  ...
                  const itemCommonProps = {
                    value,
                    title: String(label),
                    className: clsx(utility.ellipsis, scss.item, itemClassName),
                    ...
                    <Tooltip key={value} {...tooltipProps} className={tooltipClassNames}>
                      <RadixSelect.Item {...{ ...restItemProps, ...itemCommonProps }}>
                        <IconExtended
                          ...
                          size={16}
                          {...iconLeftProps}
                          className={clsx(iconLeftProps?.className, scss.icon)}
                        ...
                        <IconExtended
                          ...
                          size={14}
                          {...iconRightProps}
                          className={clsx(iconRightProps?.className, scss.icon)}
                          data-element="select-item-icon"
                        />
